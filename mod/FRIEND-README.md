...
1. Unzip the `pbj-peer-win-x64` zip anywhere. It is one big `.exe` (~71 MB
...
Only after stage 1 works. **I will send you the `pb-and-j-mod` zip then** —
you do not need it yet.

### Install the mod

1. Unzip the `pb-and-j-mod` zip.
