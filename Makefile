...
.PHONY: test build dist deploy check-game-hash check-mod-version check-wire-surface record-wire-surface wire-surface-hash clean log peer peer-selftest peer-connect peer-listen package
